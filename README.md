# Вёрстка макета testhtml-loremipsum-net

Demo online: https://ozz.life/portfolio/website-layouts/testhtml-loremipsum-net

## Установка и запуск

```bash
git clone git://github.com/ozz-life/testhtml-loremipsum-net/
cd testhtml-loremipsum-net/
yarn
yarn dev
```
